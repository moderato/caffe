...
save_dir = "models/VGGNet/GTSDB/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/GTSDB/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/GTSDB/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/Documents/data/GTSDBdevkit/results/GTSDB/{}_score/Main".format(os.environ['HOME'], job_name)
...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [6000, 18000, 30000], # [6000, 18000, 30000]
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 0,
