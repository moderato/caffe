...
# The database file for testing data. Created by data/GTSDB/create_data.sh
test_data = "examples/GTSDB/GTSDB_test_lmdb"
...
model_name = "SqueezeNet10_GTSDB_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/SqueezeNet10/GTSDB/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/SqueezeNet10/GTSDB/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/SqueezeNet10/GTSDB/{}".format(job_name)
...
# The pretrained model. We use SqueezeNet-v1.0.
pretrain_model = "models/SqueezeNet10/squeezenet_v10.caffemodel"
# Stores LabelMapItem.
...
mbox_source_layers = ['fire5/concat', 'fire9/concat', 'ssd1_2', 'ssd2_2', 'ssd3_2', 'ssd4_2']
# in percent %
min_ratio = 20
max_ratio = 95
...
det_out_param = {
    ...
    'share_location': share_location,
    'background_label_id': background_label_id,
    'nms_param': {'nms_threshold': 0.45, 'top_k': nms_top_k},
    'save_output_param': {
...
SqueezeNetV10Body(net, from_layer='data')
