...
save_dir = "models/VGGNet/GTSDB/{}_speed".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/GTSDB/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/GTSDB/{}_speed".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/Documents/data/GTSDBdevkit/results/GTSDB/{}_speed/Main".format(os.environ['HOME'], job_name)
