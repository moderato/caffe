...
# The pretrained model. We use MobileNet v1.
pretrain_model = "models/MobileNet/mobilenet.caffemodel"
# pretrain_model = "examples/MobileNet-SSD/mobilenet_iter_73000.caffemodel"
# Stores LabelMapItem.
...
MobileNetV1Body(net, from_layer='data', alpha=alpha, ssd=True, use_depthwise=False)
